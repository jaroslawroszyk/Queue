...
set(stdout_log "/mnt/c/private/NaukaZmackiem/Queue/build/external/gtest/src/googletest-stamp/googletest-build-out.log")
set(stderr_log "/mnt/c/private/NaukaZmackiem/Queue/build/external/gtest/src/googletest-stamp/googletest-build-err.log")
execute_process(
  COMMAND ${command}
...
if(result)
  ...
  if (${log_merged})
    ...
    set(msg "${msg}\nSee also\n  /mnt/c/private/NaukaZmackiem/Queue/build/external/gtest/src/googletest-stamp/googletest-build-*.log")
  endif()
  ...
  set(msg "googletest build command succeeded.  See also /mnt/c/private/NaukaZmackiem/Queue/build/external/gtest/src/googletest-stamp/googletest-build-*.log")
  message(STATUS "${msg}")
endif()
